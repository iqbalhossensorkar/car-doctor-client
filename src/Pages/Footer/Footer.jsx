    ...
    return (
        <div className="bg-[#151515]">
            <div className='max-w-7xl mx-auto'>
                <footer className="footer p-10  text-white py-20">
                    <div>
                        <img src={logo} alt="" />

                        <p className="mt-4">Edwin Diaz is a software and web <br /> technologies engineer, a life coach <br /> trainer who is also a serial .</p>
                        <div className="grid grid-flow-col gap-4 mt-5">
                            <label className="btn btn-circle btn-md">
